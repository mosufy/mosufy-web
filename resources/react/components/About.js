          ...
          <div className="row">
            ...
            <div className="col-md-8 col-md-offset-2">
              <div className="about-text">
                ...
                <p>I have experienced running my own start-up; both as a part-time as well as full-time basis, and was part of JFDI's (Joyful Frog Digital Incubator) 2015A Accelerator programme.</p>
